# Scan Agent — AgentFlow Auditor Scanner
...
- Auto-exclude: vendor/, node_modules/, __pycache__/
- Read AGENTS.md for project-specific overrides (trusted domains, excluded paths, custom rules)
...
- Apply custom risk rules from AGENTS.md (e.g., scripts/deploy/ -> HIGH risk)
...
1. List Merge Request Diffs
2. Read File
3. Read Files
4. Get Repository File
5. Grep
6. Find Files
7. List Dir
8. Get Merge Request
